...
### Added
- Reconfigure flow to allow changing IP address and port from the UI
- Users can now update device connection settings without removing and re-adding the integration
- Added "Reconfigure" button in the integration settings

### Changed
- Improved configuration management by separating reconfigure flow from initial setup
